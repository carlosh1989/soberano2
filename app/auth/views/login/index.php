                        ...
                        <?php echo Token::field() ?>
                            <div class="row control-group">
                                <div class="form-group col-xs-12 floating-label-form-group controls">
                                    ...
                                    <input name="username" type="text" class="form-control" placeholder="Usuario" id="email" required data-validation-required-message="Ingrese usuario de sessión.">
                                </div>
                            </div>
                            <div class="row control-group">
                                <div class="form-group col-xs-12 floating-label-form-group controls">
                                    <label for="password">PASSWORD</label>
                                    <input name="password" type="password" class="form-control" placeholder="Password" id="password" required data-validation-required-message="Ingrese su clave de sessión.">
                                </div>
                            </div>
                            <br>
                            <div class="row">
